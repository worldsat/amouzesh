...
public class TeacherNameListSelectedAdapter extends RecyclerView.Adapter<TeacherNameListSelectedAdapter.ViewHolder> {
    ...
    public TeacherNameListSelectedAdapter(ArrayList<CustomGroupGetById.Data.UsersToCustomGroups> result, PostMiniListAdapter.SelectCallBack selectCallBack) {
