...
public class PostSmallAdapter extends RecyclerView.Adapter<PostSmallAdapter.ViewHolder> {

    private final ArrayList<EducationPostGetAll.Data> array_object;

    public PostSmallAdapter(ArrayList<EducationPostGetAll.Data> array_object) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        Glide.with(holder.itemView.getContext())
                ...
                .load(settingsBll.getUrlAddress() + array_object.get(position).getIconUrl())
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(holder.itemView.getContext(), ShowPostActivity.class);
