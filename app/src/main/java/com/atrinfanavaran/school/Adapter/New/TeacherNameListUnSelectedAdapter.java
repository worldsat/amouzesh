...
public class TeacherNameListUnSelectedAdapter extends RecyclerView.Adapter<TeacherNameListUnSelectedAdapter.ViewHolder> {

    private final ArrayList<GetRelatedTeachersFromCustomGroup.Data> array_object;
    private Context context;

    private Handler mHandler = new Handler();
    private int mFileDuration;
    private PostMiniListAdapter.SelectCallBack selectCallBack;
    public TeacherNameListUnSelectedAdapter(ArrayList<GetRelatedTeachersFromCustomGroup.Data> result, PostMiniListAdapter.SelectCallBack selectCallBack) {
...
//                alertQuestion(context, holder, isChecked);
                ...
                selectCallBack.Id(array_object.get(position).getIdHelper(),false);
            }
        });
    }
