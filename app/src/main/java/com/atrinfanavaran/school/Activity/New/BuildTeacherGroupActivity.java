...
public class BuildTeacherGroupActivity extends BaseActivity {
    ...
    private void getData(boolean search) {
        ...
        controller().GetFromApi2(address, new CallbackGetString() {
            ...
            public void onError(String error) {
                Toast.makeText(BuildTeacherGroupActivity.this, error, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setVariable() {
        ...
        floatingActionButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(BuildTeacherGroupActivity.this, SendCategoryActivity.class));
            }
        });
...
//                    Toast.makeText(ListCategoryActivity.this, "لطفا متن جستجو را وارد نمائید", Toast.LENGTH_SHORT).show();
    ...
    private void bottomView() {
        ...
        btn2.setOnClickListener(v -> {
            Intent intent = new Intent(BuildTeacherGroupActivity.this, Main2Activity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            startActivity(intent);
            overridePendingTransition(0, 0); //0 for no animation
        });
        btn3.setOnClickListener(v -> {
            Intent intent = new Intent(BuildTeacherGroupActivity.this, Main3Activity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            startActivity(intent);
            overridePendingTransition(0, 0); //0 for no animation
        });
        btn4.setOnClickListener(v -> {
            Intent intent = new Intent(BuildTeacherGroupActivity.this, ListPostActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            startActivity(intent);
            overridePendingTransition(0, 0); //0 for no animation
        });
