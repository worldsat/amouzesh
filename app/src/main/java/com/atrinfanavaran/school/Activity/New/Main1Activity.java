...
public class Main1Activity extends BaseActivity {
        ...
        if (hm != null) {
            if (hm.isVisible()) {
                ...
                if (TimeBackPressed + Time_Between_Two_Back > System.currentTimeMillis()) {
                    ...
                    Toast.makeText(Main1Activity.this, "به منظور خروج دوباره کلیک کنید", Toast.LENGTH_SHORT).show();
                }
    ...
    private void bottomView() {
        ...
        btn1.setOnClickListener(v -> {
            Intent intent = new Intent(Main1Activity.this, ProfileActivity.class);
        ...
        btn5.setOnClickListener(v -> {
            Intent intent = new Intent(Main1Activity.this,BookmarkListActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            startActivity(intent);
            overridePendingTransition(0,0); //0 for no animation
        });
