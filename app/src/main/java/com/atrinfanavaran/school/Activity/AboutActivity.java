...
import com.atrinfanavaran.school.Domain.AboutUs;
...
//        recyclerView = findViewById(R.id.View);
    ...
    private void getData() {
        ...
        controller().GetFromApi2("api/AboutUs", new CallbackGetString() {
                    @Override
                    public void onSuccess(String resultStr) {
                        ...
                        try {
                            ...
                            AboutUs response = gson.fromJson(str, AboutUs.class);
